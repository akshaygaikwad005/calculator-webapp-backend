    ...
    stages {
        ...
        stage('Git Staging'){
            ...
            steps{
                ...
                checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-cred', url: 'https://github.com/akshaygaikwad005/calculator-webapp-backend.git']]])
